...
class RadarAxes(PolarAxes):
    ...
    def __init__(
        ...
        rect = None, 
        spoke_count = 0, 
        radar_patch_type = "polygon", 
        radar_spine_type = "circle", 
        *args, 
        **kwargs):
        ...
        self.radar_theta = (1.75 * np.pi * np.linspace(0, 1 - 1.0 / self.spoke_count, self.spoke_count))
    ...
    def plot(self, *args, **kwargs):
        ...
        for line in lines:
            self._closeLine(line)

    def _closeLine(self, line):
        x, y = line.get_data()
    ...
    def _genAxesPatch(self):
        return self.drawPatch()

    def _genAxesSpines(self):
